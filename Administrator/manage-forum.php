...
if(strlen($_SESSION['alogin'])==0)
{
    ...
    <html>
    <head>
        <title>YATHRAA | Admin Manage Forum</title>
    ...
    <div class="page-container">
        ...
        <div class="left-content">
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Home</a><i class="fa fa-angle-right"></i>Manage Forum</li>
            </ol>
            <div class="agile-grids">
                ...
                <div class="agile-tables">
                    <div class="w3l-table-info">
                        <h2><b>Manage Forum</b>&nbsp&nbsp&nbsp</h2>
